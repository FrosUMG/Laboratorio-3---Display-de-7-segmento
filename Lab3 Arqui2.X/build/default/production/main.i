...
;======================
    TMR_0:
 LOOP_TIMER1:
     BTFSS INTCON, 0002 ; VERIFICA SI LA BANDERA ((INTCON) and 07Fh), 2 ESTA ENCENDIDA
...
;===============================================================================
    ...
    banksel OPTION_REG
    BCF ((OPTION_REG) and 07Fh), 5 ; RELOJ INTERNO PARA TIMER
    BCF ((OPTION_REG) and 07Fh), 3 ; ASIGNA PRESCALER AL TMR0

    BSF ((OPTION_REG) and 07Fh), 0
    BSF ((OPTION_REG) and 07Fh), 1
    BSF ((OPTION_REG) and 07Fh), 2 ;SELECCIONA 1:256 PRESCALER
